...
class MonitoringController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','ubahEselon4'),
				'users'=>array('@'),
			),
	...
	public function actionubahEselon4(){
	   $satu='';	   
	   $eselon4=UnitEselon4::model()->findAllByAttributes(array('ID_BIDANG'=>$_POST['eselon3']));
	   
	   $satu.= CHtml::tag('option',
		   array('value'=>''),'Pilih Seksi/SubBagian',true);
	   
	   foreach($eselon4 as $value=>$name)
	   {
		 $satu.= CHtml::tag('option',
		   array('value'=>$eselon4[$value]['ID']),CHtml::encode($eselon4[$value]['NAMA_UNIT']),true);
	   }
	...
	public function actionCreate()
	{
		...
		$dataSatker = Satker::model()->findAll();
		
		$modelEselon3=new UnitEselon3;
		$dataEselon3 = UnitEselon3::model()->findAll();
		...
		$this->render('create',array(
			...
			'modelEselon3'=>$modelEselon3,
			'dataEselon3'=>$dataEselon3,
		));
	}
